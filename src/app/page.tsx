      ...
      <div className="flex flex-col pr-5 pl-12 w-full max-md:pl-5 max-md:max-w-full">
        <div className="flex flex-wrap gap-5 justify-between w-full text-sm font-medium max-w-[1314px] text-neutral-600 max-md:max-w-full">          <Image
          ...
          <div className="flex flex-wrap gap-8 items-center self-start mt-3.5 max-md:max-w-full">
            ...
            <div className="gap-2.5 self-stretch p-2.5 w-16 text-xs text-center rounded-md text-neutral-600">
              Log In
            </div>
            <div className="gap-2.5 self-stretch p-2.5 text-xs text-center bg-sky-600 rounded-md shadow-sm text-slate-50 w-[80px]">
              Sign Up
            </div>
          </div>
        </div>
            ...
            <div className="w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col pb-8 mt-16 w-full max-md:mt-10 max-md:max-w-full">
                <div className="max-md:max-w-full">
                  <div className="text-5xl font-bold text-stone-900 max-md:max-w-full max-md:text-4xl">
                ...
                <div className="flex gap-2 justify-center items-center self-start px-4 py-5 mt-16 text-lg font-semibold leading-none text-white bg-sky-600 rounded-2xl shadow-sm max-md:mt-10">
          ...
          <div className="flex gap-5 max-md:flex-col max-md:">
            <div className="w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center px-2 py-9 mx-auto w-full text-center bg-white rounded-3xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:mt-10">
                ...
                <div className="self-stretch mt-7 text-base leading-8 text-indigo-900">
                  Share your knowledge and earn money by tutoring fellow students.
                </div>
            ...
            <div className="ml-5 w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center px-1.5 py-8 mx-auto w-full text-center bg-white rounded-3xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:mt-10">
                ...
                <div className="self-stretch mt-6 text-base leading-8 text-indigo-900">
                  Flexible online work that fits your schedule perfectly.
                </div>
            ...
            <div className="ml-5 w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center py-8 pr-4 pl-1.5 mx-auto w-full text-center bg-white rounded-3xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:mt-10">
                ...
                <div className="self-stretch mt-9 text-base leading-8 text-indigo-900">
                  {" "}
                  Earn money through food delivery and handbill distribution.
                </div>
                <div className="flex gap-3.5 px-5 py-6 mt-11 max-w-full text-base tracking-normal leading-4 text-white rounded-[200px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] w-[156px] max-md:mt-10">
                  <div>view details</div>
                  <Image
            ...
            <div className="ml-5 w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center px-3.5 py-9 mx-auto w-full text-center bg-white rounded-3xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:mt-10">
                ...
                <div className="self-stretch mt-7 text-base leading-8 text-indigo-900">
                  Work at campus events, promotions, and university functions.
                </div>
                ...
                <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                  <div className="grow pb-9 w-full text-lg bg-blue-50 rounded-3xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:mt-10">
                    ...
                    <div className="flex flex-col items-start px-8 mt-6 max-md:px-5">                      <div className="self-stretch leading-8 text-neutral-700">
                      ...
                      <div className="mt-7 leading-loose text-neutral-600">
                        Business Major
                      </div>
                    </div>
                  </div>
                ...
                <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                  <div className="grow pb-9 w-full text-lg bg-blue-50 rounded-3xl shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:mt-10">
                    ...
                    <div className="flex flex-col items-start px-8 mt-6 max-md:px-5">                      <div className="self-stretch leading-8 text-neutral-700">
                        ...
                        <br />
                        remotely allows me to build my portfolio 
                        <br />
          ...
          <div className="w-[56%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col max-md:mt-10 max-md:max-w-full">
              ...
              <div className="flex flex-col pl-1.5 mt-11 max-md:mt-10 max-md:max-w-full">
                ...
                <div className="self-start px-16 py-6 mt-11 text-base leading-4 text-center text-white uppercase bg-sky-600 rounded-md shadow-sm max-md:px-5 max-md:mt-10">
                  Join Now
                </div>
              </div>
            </div>
        ...
        <div className="flex gap-5 max-md:flex-col max-md:">
          ...
          <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow text-base font-medium text-white max-md:mt-10">
              ...
              <div className="self-start mt-9">Find Jobs</div>
              <div className="mt-7">How It Works</div>
              <div className="self-start mt-6">Success Stories</div>
              <div className="self-start mt-6">Support</div>
            </div>
          </div>
          <div className="ml-5 w-[33%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow items-start text-base font-medium text-white max-md:mt-10">
              ...
              <div className="self-stretch mt-9">Post a Job</div>
              <div className="mt-6">Terms of Service</div>
              <div className="mt-7">Privacy Policy</div>
              <div className="mt-7">About QuickShift</div>
            </div>
          </div>
        </div>
      </div>
